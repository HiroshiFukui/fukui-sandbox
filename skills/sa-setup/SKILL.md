---
name: "sa-setup"
description: Sets up AI Sandbox Architect module in a project. Use when the user requests to 'install sa module', 'configure AI Sandbox Architect', or 'setup AI Sandbox Architect'.
---
...
3. Check for per-module configuration at `{project-root}/_bmad/sa/config.yaml` and `{project-root}/_bmad/core/config.yaml`. If either file exists:
...
python3 ./scripts/merge-help-csv.py --target "{project-root}/_bmad/module-help.csv" --source ./assets/module-help.csv --legacy-dir "{project-root}/_bmad" --module-code sa
```
...
```bash
python3 ./scripts/cleanup-legacy.py --bmad-dir "{project-root}/_bmad" --module-code sa --also-remove _config --skills-dir "{project-root}/.claude/skills"
```
